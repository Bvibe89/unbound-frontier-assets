...
BASE = {
    ...
    "LeftShoulder":  (0, 0, 2),
    "RightShoulder": (0, 0, -2),
    "LeftUpperArm":  (6, 0, L*69),     # 69 not 72: keeps the arm off the torso
    "RightUpperArm": (6, 0, R*69),
    "LeftLowerArm":  (0, fl(L, 18), L*8),   # elbow bend is YAW, not pitch
    "RightLowerArm": (0, fl(R, 18), R*8),
    "LeftHand":      (0, fl(L, 4), 0),
    "RightHand":     (0, fl(R, 4), 0),
    "LeftFingers":   (0, fl(L, 16), 0),
    "RightFingers":  (0, fl(R, 16), 0),
    "LeftUpperLeg":  (2, 0, 0),
    "RightUpperLeg": (2, 0, 0),
    "LeftLowerLeg":  (-5, 0, 0),
    "RightLowerLeg": (-5, 0, 0),
...
AIM = {
    "LeftUpperArm":  (18, 0, dr(L, 15)), "RightUpperArm": (-6, 0, ab(R, 17)),
    "LeftLowerArm":  (0, fl(L, 67), 0),  "RightLowerArm": (0, fl(R, 97), 0),
    "LeftHand":      (0, fl(L, 6), 0),   "RightHand":     (0, fl(R, 4), 0),
    "LeftFingers":   (0, fl(L, 22), 0),  "RightFingers":  (0, fl(R, 22), 0),
...
_sp_armA = {"LeftUpperArm": (34, 0, L*6), "RightUpperArm": (-26, 0, R*6),
            ...
            "LeftFingers": (0, 0, L*18), "RightFingers": (0, 0, R*18),
...
CLIPS["Reload"] = dict(frames=48, loop=False, keys={
    0:  merge(AIM, {}),
    8:  merge(AIM, {"RightUpperArm": (-34, 0, R*8), "RightLowerArm": (0, fl(R, -18), 0),
                    "RightFingers": (0, 0, -R*20), "LeftUpperArm": (-8, 0, L*6),
                    "LeftLowerArm": (0, fl(L, -6), 0), "UpperChest": (-1, 6, 0),
                    "Head": (3, -8, 0), "Neck": (0, -5, 0)}),
    16: merge(AIM, {"RightUpperArm": (-16, 0, R*4), "RightLowerArm": (0, fl(R, 14), 0),
                    "RightFingers": (0, 0, R*10), "LeftUpperArm": (-6, 0, L*4),
                    "Head": (2, -10, 0), "Neck": (0, -6, 0)}),
    24: merge(AIM, {"RightUpperArm": (6, 0, 0), "RightLowerArm": (0, fl(R, 22), 0),
                    "RightFingers": (0, 0, R*4), "LeftUpperArm": (-3, 0, 0),
...
_air = {"LeftUpperLeg": (40, 0, L*-8), "RightUpperLeg": (-26, 0, R*-5),
        ...
        "LeftFingers": (0, 0, L*8), "RightFingers": (0, 0, R*8)}
...
CLIPS["Land"] = dict(frames=16, loop=False, keys={
    0: merge(_air, {}),
    3: {"LeftUpperLeg": (32, 0, 0), "RightUpperLeg": (32, 0, 0),
        "LeftLowerLeg": (-62, 0, 0), "RightLowerLeg": (-62, 0, 0),
        "LeftFoot": (28, 0, 0), "RightFoot": (28, 0, 0),
        "Spine": (-16, 0, 0), "Chest": (-9, 0, 0), "UpperChest": (-5, 0, 0),
        "Neck": (14, 0, 0), "Head": (4, 0, 0),
        "LeftUpperArm": (-20, 0, ab(L, 16)), "RightUpperArm": (-20, 0, ab(R, 16)),
        "LeftLowerArm": (0, fl(L, 26), 0), "RightLowerArm": (0, fl(R, 26), 0)},
    8: {"LeftUpperLeg": (12, 0, 0), "RightUpperLeg": (12, 0, 0),
        "LeftLowerLeg": (-24, 0, 0), "RightLowerLeg": (-24, 0, 0),
        "LeftFoot": (11, 0, 0), "RightFoot": (11, 0, 0),
        "Spine": (-6, 0, 0), "Chest": (-3, 0, 0), "Neck": (5, 0, 0),
        "LeftUpperArm": (-6, 0, ab(L, 6)), "RightUpperArm": (-6, 0, ab(R, 6)),
        "LeftLowerArm": (0, fl(L, 8), 0), "RightLowerArm": (0, fl(R, 8), 0)},
    16: {},
}, hips={0: (0, 0, 0.02), 3: (0, 0, -0.105), 8: (0, 0, -0.035), 16: (0, 0, 0)})
...
CLIPS["Death"] = dict(frames=48, loop=False, keys={
    ...
    42: {"Hips": (72, 0, 0),
         ...
         "LeftFingers": (0, 0, -L*10), "RightFingers": (0, 0, -R*10)},
    48: {"Hips": (78, 0, 0),
         "Spine": (6, 0, 0), "Chest": (4, 0, 0), "Neck": (-6, 0, 0), "Head": (-13, 0, 4),
         "LeftUpperLeg": (10, 0, L*16), "RightUpperLeg": (8, 0, R*12),
         "LeftLowerLeg": (-5, 0, 0), "RightLowerLeg": (-9, 0, 0),
         ...
         "LeftFingers": (0, 0, -L*11), "RightFingers": (0, 0, -R*11)},
...
CLAMP = {
    ...
    "Fire": 0.0, "Reload": 0.0, "Land": 0.0, "Death": 0.0,
